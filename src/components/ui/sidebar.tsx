...
const SIDEBAR_WIDTH_ICON = "3.5rem" // Slightly wider for better icon spacing
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-transparent", // bg-sidebar removed to allow body background through
              className
            )}
            ref={ref}
            {...props}
        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            className={cn(
              ...
              "bg-sidebar-background/70 dark:bg-sidebar-background/50 backdrop-blur-xl shadow-2xl border-r border-white/10 dark:border-white/5" // Glassmorphism for mobile sheet
            )}
            style={
              {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=offcanvas]:hover:bg-sidebar-background/30", // Adjusted hover bg
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-3 mt-auto", className)} // Adjusted padding and margin-top
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("mx-2 my-1 w-auto bg-white/10 dark:bg-white/5", className)} // Adjusted color for glass theme
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden p-1 group-data-[collapsible=icon]:overflow-hidden", // Adjusted padding
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    className={cn("flex w-full min-w-0 flex-col gap-0.5 px-1", className)} // Adjusted gap and padding
    {...props}
  />
))
